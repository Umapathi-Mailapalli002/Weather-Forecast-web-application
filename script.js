        ...
        class="w-[90vw] lg:w-[24.5vw] lg:h-[30vh] h-[30vh] backdrop-brightness-0 backdrop-opacity-10 rounded-3xl flex justify-between">
          <div class="card mt-6 font-medium ml-8 mr-4">
           <h3 class="text-[1.3rem] lg:text-[1.7rem]">(${weatherItem.dt_txt.split(" ")[0]})</h3>
            <div class="flex justify-start items-center"><img class="size-10" src="temp.gif" alt=""><h4 class="flex">${(weatherItem.main.temp- 273.15).toFixed(2)}°C</h4></div>
            <div class="flex justify-start items-center"><img class="size-10" src="wind.gif" alt=""><h4>${weatherItem.wind.speed}M/S</h4></div>
            <div class="flex justify-start items-center"><img class="size-10" src="humidity.gif" alt=""><h4>${weatherItem.main.humidity}%</h4></div>
         </div>
